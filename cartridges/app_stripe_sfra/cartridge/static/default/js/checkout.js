    ...
    $.each(uuidEl, function (shipmentIndex, el) {
      ...
      if ($shippingMethodList && $shippingMethodList.length > 0) {
        ...
        $.each(shippingMethods, function (methodIndex, shippingMethod) {
          ...
          // set input
          $('input', tmpl).prop('id', 'shippingMethod-' + shippingMethod.ID + '-' + shipping.UUID + lineItemUUIDPart).prop('name', shippingMethodFormID).prop('value', shippingMethod.ID).attr('checked', shippingMethod.ID === selected.ID);
          $('label', tmpl).prop('for', 'shippingMethod-' + shippingMethod.ID + '-' + shipping.UUID + lineItemUUIDPart);
...
/***/ "./cartridges/app_stripe_sfra/cartridge/client/default/js/checkout/billing.js":
/*!************************************************************************************!*\
  !*** ./cartridges/app_stripe_sfra/cartridge/client/default/js/checkout/billing.js ***!
  \************************************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
/***/ "./cartridges/app_stripe_sfra/cartridge/client/default/js/checkout/checkout.js":
/*!*************************************************************************************!*\
  !*** ./cartridges/app_stripe_sfra/cartridge/client/default/js/checkout/checkout.js ***!
  \*************************************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
var base = __webpack_require__(/*! base/checkout/checkout */ "./cartridges/app_storefront_base/cartridge/client/default/js/checkout/checkout.js");
var billingHelpers = __webpack_require__(/*! ./billing */ "./cartridges/app_stripe_sfra/cartridge/client/default/js/checkout/billing.js");
...
!function() {
/*!****************************************************************************!*\
  !*** ./cartridges/app_stripe_sfra/cartridge/client/default/js/checkout.js ***!
  \****************************************************************************/
/* global $ */
...
$(document).ready(function () {
  processInclude(__webpack_require__(/*! ./checkout/checkout */ "./cartridges/app_stripe_sfra/cartridge/client/default/js/checkout/checkout.js"));
});
}();
/******/ })()
;