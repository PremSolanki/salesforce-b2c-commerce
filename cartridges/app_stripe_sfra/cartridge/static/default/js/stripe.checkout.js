...
function getOwnerDetails() {
  var stateElement = document.querySelector('.billing-address select[name$="_stateCode"]') || document.querySelector('.billing-address input[name$="_stateCode"]') || document.querySelector('select[name$="_stateCode"]') || document.querySelector('input[name$="_stateCode"]');
  var ownerNames = document.querySelector('.billing-address input[name$="_firstName"]') && document.querySelector('.billing-address input[name$="_lastName"]') ? document.querySelector('.billing-address input[name$="_firstName"]').value + ' ' + document.querySelector('.billing-address input[name$="_lastName"]').value : document.querySelector('input[name$="_firstName"]').value + ' ' + document.querySelector('input[name$="_lastName"]').value;
  var addrLine1 = document.querySelector('.billing-address input[name$="_address1"]') ? document.querySelector('.billing-address input[name$="_address1"]').value : document.querySelector('input[name$="_address1"]').value;
  var addrLine2 = document.querySelector('.billing-address input[name$="_address2"]') ? document.querySelector('.billing-address input[name$="_address2"]').value : document.querySelector('input[name$="_address2"]').value;
  var addrCity = document.querySelector('.billing-address input[name$="_city"]') ? document.querySelector('.billing-address input[name$="_city"]').value : document.querySelector('input[name$="_city"]').value;
  var addrPostalCode = document.querySelector('.billing-address input[name$="_postalCode"]') ? document.querySelector('.billing-address input[name$="_postalCode"]').value : document.querySelector('input[name$="_postalCode"]').value;
  var addrCountry = document.querySelector('.billing-address select[name$="_country"]') ? document.querySelector('.billing-address select[name$="_country"]').value : document.querySelector('select[name$="_country"]').value;
  var ownerEmail = '';
  if ($('.customer-summary-email').length && $('.customer-summary-email').text()) {
    ownerEmail = $('.customer-summary-email').text();
  } else {
    ownerEmail = document.querySelector('#dwfrm_billing input[name$="_email"]') ? document.querySelector('#dwfrm_billing input[name$="_email"]').value : document.querySelector('input[name$="_email"]').value;
  }
  ...
  var ownerPhone = document.querySelector('#dwfrm_billing input[name$="_phone"]') ? document.querySelector('#dwfrm_billing input[name$="_phone"]').value : document.querySelector('input[name$="_phone"]').value;
  return {
    name: ownerNames,
    address: {
      line1: addrLine1,
...
ready(function () {
  ...
  document.querySelector('.payment-summary .edit-button').addEventListener('click', function (e) {
    $('.payment-details').removeClass('payment-details').addClass('payment-details-stripe');
  ...
  // eslint-disable-next-line no-unused-vars
  document.querySelector('.shipping-summary .edit-button').addEventListener('click', function (e) {
    var list = document.querySelector('.payment-form').querySelectorAll('.tab-pane');
    for (var i = 0; i < list.length; ++i) {
      list[i].classList.remove('active');
    }
...
function initNewStripePaymentIntent() {
  ...
  var stripePaymentElementStyleObject = JSON.parse(document.getElementById('stripePaymentElementStyle').value);
...
ready(function () {
  // eslint-disable-next-line no-unused-vars
  document.querySelector('.submit-shipping').addEventListener('click', function (e) {
    initStripePaymentElement();
  });
